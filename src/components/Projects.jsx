...
const projects = [
  {
    ...
    github: "https://github.com/danad1821/ASDetector",
    demo: "https://drive.google.com/file/d/1IyUC7bP96DVvJtoIAGOALzO8y8F3jKcm/view",
    images: [
    ...
    title: "MarketTrivia",
    description:
      "Delivered a full-stack financial forecasting application using Django and Python. The core system incorporates a predictive model that uses Logistic regression to forecast stock and crypto price trends and leverages NLP (Vader NLTK) for sentiment analysis of financial news titles.",
    tech: [
      "Django",
      "Logistic Regression",
      "Selenium",
    ...
    github: "",
    demo: "https://drive.google.com/file/d/1y4AHB6LNFHI_unvgPWIzyut8CHh7fv5H/view?usp=sharing&usp=embed_facebook",
    images: [
      "Images/MarketTrivia/Ds1.png",
      "Images/MarketTrivia/Ds2.png",
      "Images/MarketTrivia/Ds3.png",
    ],
    link: "#",
    date: "2025-04",
  },
  ...
  },
  {
    title: "Sparkle",
    description:
      "Sparkle is a a mock website for a cosmetics brand 'Sparkle' ",
